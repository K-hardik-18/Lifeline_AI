...
export async function POST(request) {
  try {
    ...
    const systemInstruction = `
      You are LifeLine AI, an expert productivity and habit tracking coach.
      ...
      2. "suggestions": An array of 1 to 3 new habit suggestions (objects with {title, category, priority, reason}) that would balance their life. Categories must be one of: 'work', 'study', 'personal', 'finance', 'health'. Priorities must be: 'critical', 'high', 'medium', 'low'.
    ...
    return NextResponse.json({
      analysis: "You're building great foundational habits! Keep tracking your progress daily to see long-term trends.",
      suggestions: [
        {
